...
public class TestDataRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        Item testItem8 = new Item(8L, testShop2, "붉은 튤립 10송이 다발5", 40000, 50000, "꽃 설명", "red", "데이트 연인 기념일", "");
        Item testItem9 = new Item(9L, testShop1, "붉은 튤립 10송이 다발6", 40000, 50000, "꽃 설명", "red", "데이트 연인 기념일", "");
        Item testItem10 = new Item(10L, testShop2, "붉은 튤립 10송이 다발7", 40000, 50000, "꽃 설명", "red", "데이트 연인 기념일", "");
